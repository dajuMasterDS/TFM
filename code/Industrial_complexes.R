...
### OJO: Aqui variamos el rango de las filas a geocodificar (2.500 maximo por día)
rangoFilas <- 1:2500
...
fichero <- paste0("./data/csv/CompByEmissions_", intervalo, ".csv")
...
write.csv2(comByEmiSelection_df, file = fichero, sep=';')
...
mymergeddata = multmerge("./data/csv")
write.csv2(mymergeddata, file="./data/csv/Comp_by_Emi_total_short_unique.csv", row.names=FALSE, na="NA", append = FALSE, sep=';')
...
compByEmiShortUnique_df <- read.csv("./data/csv/Comp_by_Emi_total_short_unique.csv", sep=";")
...
write.csv2(comByEmiTotal_df, file="./data/csv/Comp_by_Emi_total_Geo.csv", row.names=FALSE, na="NA", append = FALSE, sep=';')
